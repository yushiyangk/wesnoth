...
#define UMCD_LOG(severity) (umcd::asio_logger::get().get_logger(umcd::severity))
#define UMCD_LOG_IP(severity, socket) ((umcd::asio_logger::get().get_logger(umcd::severity)) << socket.remote_endpoint())
