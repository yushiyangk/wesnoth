...
void action_dispatcher::init_action_factory()
{
	action_factory_.register_product("request_license", boost::make_shared<request_license_action>());
	action_factory_.register_product("request_umc_upload", boost::make_shared<request_umc_upload_action>());
}
